...
- **Protected resource metadata:** `https://pons.chat/.well-known/oauth-protected-resource/api/mcp`
- **Authorization server metadata:** `https://pons.chat/.well-known/oauth-authorization-server/api/auth`
- **OpenID configuration:** `https://pons.chat/.well-known/openid-configuration/api/auth`
- **Resource URL:** `https://pons.chat/api/mcp`
