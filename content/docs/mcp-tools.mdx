...
description: Complete reference for all 9 MCP tools exposed by Pons.
---

Pons exposes 9 tools to MCP clients. Each tool requires an API key with the appropriate scope.
