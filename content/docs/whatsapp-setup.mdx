...
2. Use **Detach / Reattach Meta Connection**
3. Either:
   - **Re-attach via OTP verification** (recommended for recreated numbers), or
   - **Attach already-added number** if you already have a new Phone Number ID

This swaps the Meta connection on the existing Pons account and keeps your
conversations, contacts, members, webhook targets, and API keys.
